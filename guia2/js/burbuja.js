function inicializar() {
    ...
    var i, max, temp, contenido = "", tdelement, voto;
    ...
    do{
        voto = parseInt(prompt("Ingrese 1 si quiere el orden Ascendente o 2 si lo quiere descendente: ", ""));
        if(voto<1 || voto>2){
            alert("Error, vuelva a ingresar el número del orden");
        }
    }while(voto<1 || voto >2);
    ...
    with (document) {
        ...
        if(voto == 1){
            ...
            contenido += "<h1>Números ordenados de forma descendente</h1>\n";
            contenido += "<table>\n\t<tbody>\n\t\t<tr>\n";
            //Lazo que muestra los elementos del arreglo que han sido
            //ordenados con el método de la burbuja
            for (i = 0; i < max; i++) {
