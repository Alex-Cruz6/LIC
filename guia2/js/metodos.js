function inicializar() {
    ...
    with (document) {
        ...
        contenido += "\t\t</tr>\n\t</tbody>\n</table>\n<br />\n\n";
        do{
            voto = parseInt(prompt("Ingrese un número para el método push: ", ""));
        }while(isNaN(voto));
        numeros.push(voto);
        max++;
        //Lazo que ordena el arreglo mediante el método de la burbuja
        contenido += "<h1>Arreglo con el dato ingresado por el método push</h1>\n";
        contenido += "<table>\n\t<tbody>\n\t\t<tr>\n";
        ...
        max--;
        contenido += "\t\t</tr>\n\t</tbody>\n</table>\n<br />\n\n";
        contenido += "<h1>Arreglo modificado con el método pop</h1>\n";
        contenido += "<table>\n\t<tbody>\n\t\t<tr>\n";
        //Lazo que muestra los elementos del arreglo que han sido
        //ordenados con el método de la burbuja
        for (i = 0; i < max; i++) {
